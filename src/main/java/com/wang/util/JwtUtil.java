...
public class JwtUtil {
    ...
    public static void main(String[] args) {
        String token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJjdXJyZW50VGltZU1pbGxpcyI6IjE2MDQzOTYyODIxMDciLCJleHAiOjE2MDQzOTY1ODIsImFjY291bnQiOiJhZG1pbiJ9.Hkoh_bck-GeAf9GkMUf_oukSL455r26H89m6E6wqWGk";
        String claim = getClaim(token, Constant.CURRENT_TIME_MILLIS);
